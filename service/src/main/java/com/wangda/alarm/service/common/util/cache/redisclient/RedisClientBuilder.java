...
public abstract class RedisClientBuilder {
    ...
    public static SingleServerClientBuilder createSingle(String host, int port) {
        return new SingleServerClientBuilder(host, port);
    }
...
//    public RedisClientBuilder setPingBeforeActivateConnection(
